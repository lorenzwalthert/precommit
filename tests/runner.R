print("libpaths from Rscript")
system2("Rscript", "show-libpaths.R")
print("libpaths from R")
print(.libPaths())
...
if (length(.libPaths()) > 1) {
  path_r_prof <- fs::path("/home/.Rprofile")
  print("libpats are")
  print(.libPaths())
...
withr::with_dir(
  path_test_repo, {
    ...
    writeLines(c(
      ...
      "    rev: e767050007784aef4e6af5c89cb6aeaeccd0731f",
      "    hooks:",
